...
def run(rank, world_size):
    ...
    prompts_contexts_plm = nn.parallel.DistributedDataParallel(prompts_contexts_plm, device_ids=[rank], gradient_as_bucket_view=True)
    responses_plm = nn.parallel.DistributedDataParallel(responses_plm, device_ids=[rank], gradient_as_bucket_view=True)
    cls = nn.parallel.DistributedDataParallel(cls, device_ids=[rank], gradient_as_bucket_view=True)
